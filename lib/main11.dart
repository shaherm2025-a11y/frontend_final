...
class DatabaseHelper {
  ...
  // ✅ تحديد اللغة
  static bool get isArabic => false;
  ...
  static Future<List<Map<String, dynamic>>> getCrops() async {
    ...
    return await db.query('crops', columns: ['id', nameCol + ' as name', 'name_en']);
  }
  ...
  static Future<List<Map<String, dynamic>>> getDiseasesByCropAndStageFromJson(
    ...
    return diseases.map((d) => {
      ...
      'preventive_measures': (isArabic ? d['preventive_measures']
                                       : d['preventive_measures_en']).join(", "),
      'chemical_treatment': isArabic ? d['chemical_treatment']
                                     : d['chemical_treatment_en'],
      'alternative_treatment': isArabic ? d['alternative_treatment']
